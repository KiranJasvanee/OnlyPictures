//
//  WebImageLoaderViewController.swift
//  OnlyPictures_Example
//
//  Created by MAC241 on 5/25/18.
...
class WebImageLoaderManualCountViewController: UIViewController {
    
    @IBOutlet weak var onlyPictures: OnlyHorizontalPictures!
    var manualCountHolder: Int = 100
    ...
    var pictures: [String]  = [
        ...
        "http://insightstobehavior.com/wp-content/uploads/2017/08/testi-5.jpg",
        "https://cdn.wallpapersafari.com/79/67/oUExzR.jpg",
        "http://steezo.com/wp-content/uploads/2012/12/man-in-suit2-300x223.jpg",
        "https://cdn.wallpapersafari.com/79/67/oUExzR.jpg",
        "http://steezo.com/wp-content/uploads/2012/12/man-in-suit2-300x223.jpg",
        "http://www.daymarkinteractive.com/wp-content/uploads/2014/04/35.jpg"
    ]
...
extension WebImageLoaderManualCountViewController: OnlyPicturesDataSource {
    func numberOfPictures() -> Int {
        return self.pictures.count
    }
    func remainingCountValue() -> Int {
        return manualCountHolder
    }
...
extension WebImageLoaderManualCountViewController: OnlyPicturesDelegate {
